...
namespace TestEstante
{
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            est1.GetValorEstante((ETipoProducto)Producto.ETipoProducto.Galletita));
            ...
            est1 = est1 - (ETipoProducto)Producto.ETipoProducto.Galletita;
            ...
            est2 -= (ETipoProducto)Producto.ETipoProducto.Todos;
            Console.WriteLine("Contenido Estante2:\n{0}", Estante.MostrarEstante(est2));
            Console.ReadLine();
        }
    }
